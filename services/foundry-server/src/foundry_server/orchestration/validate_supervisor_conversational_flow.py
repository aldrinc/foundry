...
def _load_app_module():
    ...
    for name in [
        "foundry_server.orchestration.app",
        "foundry_server.orchestration.store",
        "foundry_server.orchestration.executor",
        "foundry_server.orchestration.orchestrator_policy",
        "foundry_server.orchestration.supervisor_runtime.thread_state",
    ]:
        sys.modules.pop(name, None)

    importlib.invalidate_caches()
    return importlib.import_module("foundry_server.orchestration.app")
...
def _configure_validation_env(temp_dir: str) -> None:
    ...
    os.environ["SUPERVISOR_DIR"] = str(runtime_dir)
