...
from zerver.views.foundry_tasks import (
    ...
    foundry_integration_list,
    foundry_integration_policy_update,
    foundry_provider_auth_connect,
    foundry_provider_auth_disconnect,
    foundry_provider_auth_list,
    foundry_provider_catalog,
    foundry_provider_oauth_callback,
    foundry_provider_oauth_start,
    foundry_supervisor_context,
    foundry_supervisor_memory_append,
    foundry_task_action,
    foundry_task_events,
    foundry_task_events_stream,
    foundry_topic_supervisor_session_stream,
    foundry_task_needs_clarification,
    foundry_task_reply,
...
v1_api_and_json_patterns = [
    ...
    rest_path("foundry/tasks/create", POST=foundry_create_task),
    rest_path("foundry/tasks/<path:task_id>/events", GET=foundry_task_events),
    rest_path("foundry/tasks/<path:task_id>/events/stream", GET=foundry_task_events_stream),
    rest_path("foundry/tasks/<path:task_id>/action", POST=foundry_task_action),
    rest_path(
        "foundry/tasks/<path:task_id>/needs_clarification",
        POST=foundry_task_needs_clarification,
    ),
    rest_path(
        "foundry/tasks/<path:task_id>/resolve_clarification",
    ...
    rest_path("foundry/providers/disconnect", POST=foundry_provider_auth_disconnect),
    rest_path("foundry/providers/oauth/start", POST=foundry_provider_oauth_start),
    rest_path("foundry/providers/oauth/callback", GET=foundry_provider_oauth_callback),
    rest_path("foundry/integrations/catalog", GET=foundry_integration_catalog),
    rest_path("foundry/integrations/list", GET=foundry_integration_list),
    rest_path("foundry/integrations/connect", POST=foundry_integration_connect),
    rest_path("foundry/integrations/disconnect", POST=foundry_integration_disconnect),
    rest_path("foundry/integrations/policy", POST=foundry_integration_policy_update),
    rest_path("foundry/topics/<path:topic_scope_id>/sidebar", GET=foundry_topic_sidebar),
    rest_path("foundry/topics/<path:topic_scope_id>/events", GET=foundry_topic_events),
    rest_path(
    ...
    rest_path(
        "foundry/topics/<path:topic_scope_id>/supervisor/session/reset",
        POST=foundry_topic_supervisor_session_reset,
    ),
    rest_path(
        "foundry/topics/<path:topic_scope_id>/supervisor/message",
        POST=foundry_topic_supervisor_message,
    ),
    rest_path(
        "foundry/topics/<path:topic_scope_id>/plan/revisions",
        GET=foundry_topic_plan_revisions,
        POST=foundry_topic_plan_create,
    ),
    rest_path("foundry/topics/<path:topic_scope_id>/plan/current", GET=foundry_topic_plan_current),
    rest_path(
