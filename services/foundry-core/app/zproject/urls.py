...
from zerver.views.meridian_tasks import (
    meridian_create_task,
    meridian_integration_catalog,
    meridian_integration_connect,
    meridian_integration_disconnect,
    meridian_integration_list,
    meridian_integration_policy_update,
    meridian_provider_auth_connect,
    meridian_provider_auth_disconnect,
    meridian_provider_auth_list,
    meridian_provider_catalog,
    meridian_provider_oauth_callback,
    meridian_provider_oauth_start,
    meridian_supervisor_context,
    meridian_supervisor_memory_append,
    meridian_task_action,
    meridian_task_events,
    meridian_task_events_stream,
    meridian_topic_supervisor_session_stream,
    meridian_task_needs_clarification,
    meridian_task_reply,
    meridian_task_resolve_clarification,
    meridian_task_status,
    meridian_topic_directive_dispatch,
    meridian_topic_events,
    meridian_topic_plan_create,
    meridian_topic_plan_current,
    meridian_topic_plan_revisions,
    meridian_topic_plan_synthesize,
    meridian_topic_supervisor_message,
    meridian_topic_supervisor_session,
    meridian_topic_supervisor_session_reset,
    meridian_topic_sidebar,
)
...
v1_api_and_json_patterns = [
    ...
    rest_path("meridian/tasks/create", POST=meridian_create_task),
    rest_path("meridian/tasks/<path:task_id>/events", GET=meridian_task_events),
    rest_path("meridian/tasks/<path:task_id>/events/stream", GET=meridian_task_events_stream),
    rest_path("meridian/tasks/<path:task_id>/action", POST=meridian_task_action),
    rest_path(
        "meridian/tasks/<path:task_id>/needs_clarification",
        POST=meridian_task_needs_clarification,
    ),
    rest_path(
        "meridian/tasks/<path:task_id>/resolve_clarification",
        POST=meridian_task_resolve_clarification,
    ),
    rest_path("meridian/tasks/<path:task_id>/reply", POST=meridian_task_reply),
    rest_path("meridian/tasks/<path:task_id>", GET=meridian_task_status),
    rest_path("meridian/providers/catalog", GET=meridian_provider_catalog),
    rest_path("meridian/providers/auth", GET=meridian_provider_auth_list),
    rest_path("meridian/providers/connect", POST=meridian_provider_auth_connect),
    rest_path("meridian/providers/disconnect", POST=meridian_provider_auth_disconnect),
    rest_path("meridian/providers/oauth/start", POST=meridian_provider_oauth_start),
    rest_path("meridian/providers/oauth/callback", GET=meridian_provider_oauth_callback),
    rest_path("meridian/integrations/catalog", GET=meridian_integration_catalog),
    rest_path("meridian/integrations/list", GET=meridian_integration_list),
    rest_path("meridian/integrations/connect", POST=meridian_integration_connect),
    rest_path("meridian/integrations/disconnect", POST=meridian_integration_disconnect),
    rest_path("meridian/integrations/policy", POST=meridian_integration_policy_update),
    rest_path("meridian/topics/<path:topic_scope_id>/sidebar", GET=meridian_topic_sidebar),
    rest_path("meridian/topics/<path:topic_scope_id>/events", GET=meridian_topic_events),
    rest_path(
        "meridian/topics/<path:topic_scope_id>/supervisor/session",
        GET=meridian_topic_supervisor_session,
    ),
    rest_path(
        "meridian/topics/<path:topic_scope_id>/supervisor/session/stream",
        GET=meridian_topic_supervisor_session_stream,
    ),
    rest_path(
        "meridian/topics/<path:topic_scope_id>/supervisor/session/reset",
        POST=meridian_topic_supervisor_session_reset,
    ),
    rest_path(
        "meridian/topics/<path:topic_scope_id>/supervisor/message",
        POST=meridian_topic_supervisor_message,
    ),
    rest_path(
        "meridian/topics/<path:topic_scope_id>/plan/revisions",
        GET=meridian_topic_plan_revisions,
        POST=meridian_topic_plan_create,
    ),
    rest_path("meridian/topics/<path:topic_scope_id>/plan/current", GET=meridian_topic_plan_current),
    rest_path(
        "meridian/topics/<path:topic_scope_id>/plan/synthesize",
        POST=meridian_topic_plan_synthesize,
    ),
    rest_path(
        "meridian/topics/<path:topic_scope_id>/directives/dispatch",
        POST=meridian_topic_directive_dispatch,
    ),
    rest_path("meridian/supervisor/context", GET=meridian_supervisor_context),
    rest_path("meridian/supervisor/memory", POST=meridian_supervisor_memory_append),
    rest_path(
