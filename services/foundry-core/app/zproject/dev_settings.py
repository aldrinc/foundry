...
if os.getenv("BEHIND_HTTPS_PROXY"):
    ...
    CSRF_TRUSTED_ORIGINS = [
        EXTERNAL_URI_SCHEME + EXTERNAL_HOST,
        EXTERNAL_URI_SCHEME + "*." + EXTERNAL_HOST_WITHOUT_PORT,
    ]
...
RATE_LIMITING_RULES = {
    ...
    "api_by_user": [
        # Increase API rate limit for development — default 200/min is too low
        # when the supervisor SSE stream reconnects or multiple clients are active.
        (60, 600),
    ],
}
