...
export declare function getProviderConnectionStatus(provider: FoundryProviderAuth): string;
export declare function getProviderDefaultModel(provider: FoundryProviderAuth): string | null;
export declare function normalizeProvider(provider: FoundryProviderAuth): FoundryProviderAuth;
