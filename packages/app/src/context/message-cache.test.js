...
import { ALL_MESSAGES_NARROW, STARRED_NARROW, cacheKeysForMessage, mergeMessagesById, primaryNarrowForMessage, } from "./message-cache";
describe("message cache helpers", () => {
    ...
    test("derives primary narrow for stream messages", () => {
        expect(primaryNarrowForMessage({
            id: 20,
            type: "stream",
            subject: "incident",
            stream_id: 8,
