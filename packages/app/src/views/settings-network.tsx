        ...
        <div class="space-y-4 pl-4 border-l-2 border-[var(--border-default)]">
          ...
          <div>
            ...
            <input
              ...
              placeholder="http=proxy:8080;https=proxy:8443"
              value={store.proxyRules}
              onInput={(e) => setSetting("proxyRules", e.currentTarget.value)}
            />
            <div class="text-[10px] text-[var(--text-tertiary)] mt-1">
          ...
          <div>
            ...
            <input
              ...
              value={store.bypassRules}
              onInput={(e) => setSetting("bypassRules", e.currentTarget.value)}
            />
            <div class="text-[10px] text-[var(--text-tertiary)] mt-1">
