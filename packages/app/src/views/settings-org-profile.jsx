    ...
    return (<div class="space-y-6">
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            <div class="text-sm font-medium text-[var(--text-primary)]">{org.realmName}</div>
        ...
        <div>
          ...
          <input type="text" class="w-full text-xs bg-[var(--background-base)] border border-[var(--border-default)] rounded-[var(--radius-sm)] px-2 py-1.5 text-[var(--text-primary)]" value={org.realmName} readOnly/>
          <div class="text-[10px] text-[var(--text-tertiary)] mt-1">Only organization administrators can change this.</div>
        </div>

        {/* Org Description */}
        <div>
          <label class="text-[10px] font-medium text-[var(--text-tertiary)] uppercase tracking-wider block mb-1">Description</label>
          <textarea class="w-full text-xs bg-[var(--background-base)] border border-[var(--border-default)] rounded-[var(--radius-sm)] px-2 py-1.5 text-[var(--text-primary)] min-h-[60px] resize-y" placeholder="Add a description for your organization..." readOnly/>
        </div>
