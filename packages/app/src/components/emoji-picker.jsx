...
export function EmojiPicker(props) {
    ...
    return (<div class="w-[280px] bg-[var(--background-surface)] border border-[var(--border-default)] rounded-[var(--radius-md)] shadow-md overflow-hidden" data-component="emoji-picker" onClick={(e) => e.stopPropagation()}>
      {/* Search */}
