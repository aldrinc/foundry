    ...
    <div class="relative" ref={menuRef!}>
      ...
      >
        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
          ...
          />
          <path
            d="M5.5 5.5a1.5 1.5 0 0 1 2.8.5c0 1-1.3 1.3-1.3 2"
            stroke="currentColor"
            stroke-width="1.2"
        ...
        <div class="absolute right-0 top-full mt-1 w-[200px] bg-[var(--background-surface)] border border-[var(--border-default)] rounded-[var(--radius-md)] shadow-lg z-50 py-1">
          ...
          <div class="px-3 py-1.5">
            <div class="text-[10px] text-[var(--text-tertiary)]">
              Search filters:{" "}
              <span class="text-[var(--text-secondary)]">stream:</span>,{" "}
              <span class="text-[var(--text-secondary)]">topic:</span>,{" "}
              <span class="text-[var(--text-secondary)]">sender:</span>
            </div>
          </div>
          <div class="my-1 border-t border-[var(--border-default)]" />
          <div class="px-3 py-1.5">
            <span class="text-[10px] text-[var(--text-tertiary)]">
              Foundry Desktop &middot; Built with Tauri + SolidJS
            </span>
          </div>
        </div>
      </Show>
