...
export function SupervisorDelegateRoster() {
    ...
    return (<Show when={delegates().length > 0}>
      <div class="px-3 py-2 border-b border-[var(--border-default)] bg-[var(--background-base)]" data-component="supervisor-delegate-roster">
        ...
        <div class="flex flex-wrap gap-1.5 mt-2">
          <For each={delegates()}>
            {(delegate) => (<div class="px-2 py-1 rounded-[var(--radius-sm)] bg-[var(--background-elevated)] text-[10px] text-[var(--text-secondary)]">
