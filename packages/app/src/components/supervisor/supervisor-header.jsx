...
export function SupervisorHeader() {
    ...
    return (<div class="h-12 flex items-center justify-between px-3 border-b border-[var(--border-default)] bg-[var(--background-elevated)]" data-component="supervisor-header">
      ...
      <button onClick={() => supervisor.close()} class="shrink-0 p-1 rounded-[var(--radius-sm)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--background-base)] transition-colors" title="Close supervisor">
