...
const FORMAT_ACTIONS: FormatAction[] = [
  {
    ...
    icon: (
      <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
        <path
          d="M3 2h4a2.5 2.5 0 010 5H3V2zM3 7h4.5a2.5 2.5 0 010 5H3V7z"
          stroke="currentColor"
          stroke-width="1.5"
        />
      </svg>
  ...
  },
  {
    ...
    icon: (
      <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
        <path
          d="M5 7a3 3 0 004-4L7.5 1.5a2.1 2.1 0 00-3 3L5 4"
          stroke="currentColor"
          stroke-width="1.2"
          stroke-linecap="round"
        />
        <path
          d="M7 5a3 3 0 00-4 4l1.5 1.5a2.1 2.1 0 003-3L7 8"
          stroke="currentColor"
          stroke-width="1.2"
          stroke-linecap="round"
        />
  ...
  },
  {
    ...
    icon: (
      <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
        ...
        />
        <path
          d="M8 3H5.5a1.5 1.5 0 000 3M4 9h2.5a1.5 1.5 0 000-3"
          stroke="currentColor"
          stroke-width="1.2"
        />
      </svg>
