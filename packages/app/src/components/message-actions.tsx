...
export function MessageActions(props: {
  ...
  const isOwnMessage = () =>
    props.currentUserId && props.message.sender_id === props.currentUserId;
  ...
  return (
    <div
      class="absolute -top-3 right-2 opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-0.5 bg-[var(--background-surface)] border border-[var(--border-default)] rounded-[var(--radius-md)] shadow-sm px-1 py-0.5"
    ...
    >
      ...
      <div class="relative">
        ...
        >
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
            ...
            <path
              d="M5 8.5c.5.8 1.2 1 2 1s1.5-.2 2-1"
              stroke="currentColor"
              stroke-width="1"
      ...
      >
        ...
        >
          <path
            d="M7 1.5l1.5 3 3.3.5-2.4 2.3.6 3.2L7 8.9 3.9 10.5l.6-3.2-2.4-2.3 3.4-.5L7 1.5z"
            stroke="currentColor"
            stroke-width="1.1"
            stroke-linecap="round"
      ...
      >
        ...
        >
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
            <path
              d="M6 8a2.5 2.5 0 003.5-3.5L8 3a2 2 0 00-3 3L6 5"
              stroke="currentColor"
              stroke-width="1.2"
              stroke-linecap="round"
            />
            <path
              d="M8 6a2.5 2.5 0 00-3.5 3.5L6 11a2 2 0 003-3L8 9"
              stroke="currentColor"
              stroke-width="1.2"
              stroke-linecap="round"
            />
      ...
      <Show when={isOwnMessage()}>
        <ActionButton title="Edit" onClick={() => props.onStartEdit?.()}>
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
            <path
              d="M9.5 2.5l2 2M3 9l-0.5 2.5L5 11l6.5-6.5-2-2L3 9z"
              stroke="currentColor"
              stroke-width="1.2"
              stroke-linejoin="round"
            />
      ...
      <Show when={isOwnMessage()}>
        ...
        >
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
            <path
              d="M3.5 4h7l-.5 7.5H4L3.5 4zM2.5 4h9M5.5 2h3"
              stroke="currentColor"
              stroke-width="1.2"
              stroke-linecap="round"
              stroke-linejoin="round"
