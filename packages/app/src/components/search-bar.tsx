  ...
  return (
    <div class="relative" data-component="search-bar">
      ...
      <Show when={showResults()}>
        <div
          class="absolute top-full left-0 right-0 mt-1 bg-[var(--background-surface)] border border-[var(--border-default)] rounded-[var(--radius-md)] shadow-md max-h-[400px] overflow-y-auto z-50"
        >
          <Show when={searching()}>
