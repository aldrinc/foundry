...
export function PersonalMenu(props) {
    ...
    return (<div ref={menuRef} class="absolute left-0 top-full mt-1 w-[220px] bg-[var(--background-surface)] border border-[var(--border-default)] rounded-[var(--radius-md)] shadow-lg z-50 py-1">
      {/* User info */}
