...
export function MentionAutocomplete(props: {
  ...
  return (
    <Show when={resultCount() > 0}>
      <div
        class="absolute z-50 bg-[var(--background-surface)] border border-[var(--border-default)] rounded-[var(--radius-md)] shadow-md overflow-hidden min-w-[200px] max-w-[300px]"
        style={{
