...
- [`.github/workflows/ci.yml`](/Users/aldrinclement/Documents/programming/ideas-space/foundry/.github/workflows/ci.yml) now replaces the old Forgejo CI path with GitHub Actions
...
These items still need to happen before the repo is ready for public launch:

1. Expand [`.github/workflows`](/Users/aldrinclement/Documents/programming/ideas-space/foundry/.github/workflows) beyond CI to cover release publishing, updater artifacts, and signing-related automation.
2. Continue the Foundry rebrand inside the imported core server, where Meridian- and Zulip-era names still remain.
3. Decide how the imported core server is wired into the monorepo build, dev, and release workflows.
